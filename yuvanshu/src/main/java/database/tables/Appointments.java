...
public class Appointments extends TableImpl<AppointmentsRecord> {
    ...
    /**
     * The column <code>appointments.id</code>.
     */
    public final TableField<AppointmentsRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>appointments.patient_name</code>.
     */
    public final TableField<AppointmentsRecord, String> PATIENT_NAME = createField(DSL.name("patient_name"), SQLDataType.VARCHAR(45), this, "");

    /**
     * The column <code>appointments.date_time</code>.
     */
    public final TableField<AppointmentsRecord, LocalDateTime> DATE_TIME = createField(DSL.name("date_time"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>appointments.doctor_name</code>.
     */
    public final TableField<AppointmentsRecord, String> DOCTOR_NAME = createField(DSL.name("doctor_name"), SQLDataType.VARCHAR(45), this, "");

    /**
     * The column <code>appointments.deleated</code>.
     */
    public final TableField<AppointmentsRecord, Boolean> DELEATED = createField(DSL.name("deleated"), SQLDataType.BIT.defaultValue(DSL.inline("b'0'", SQLDataType.BIT)), this, "");
    ...
    public UniqueKey<AppointmentsRecord> getPrimaryKey() {
        return Keys.KEY_APPOINTMENTS_PRIMARY;
    }
